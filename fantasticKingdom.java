...
abstract class citizen{
	...
	//Underlying Function is Added
	//Royal was abstract class earlier
...
//King data type is changed to Citizen Data type
...
class kingdom{
	...
	//Return type was void earlier
	//Rank variable is passed
...
class kingdomThread implements Runnable {
	...
	public void run(){
		while(k.living_citizen_count >0){
			...
			System.out.println("==================================================================================");
			//Thread.sleep() was not put in try catch block earlier
			try
			{
			Thread.sleep(10000);
			}
